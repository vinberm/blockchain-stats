import deserialize, BCDataStream, util
from  deserialize import opcodes

def create(policy, **kwargs):
    mod = __import__(__name__, fromlist=[policy])
...
class BaseChain(object):
    ...
    def parse_block(chain, binary_block):
        return chain.ds_parse_block(util.str_to_ds(binary_block))
